...
--
-- Host: 127.0.0.1
-- Generation Time: Paź 31, 2023 at 12:15 PM
...
INSERT INTO `evaluations` (`EvaluationID`, `UserName`, `UserID`, `Date`, `Question1`, `Question2`, `Question3`, `Question4`, `Question5`, `Question6`, `EvaluatorNameID`, `Question10`, `Question11`, `Question7`, `Question8`, `Question9`) VALUES
(8, '1', 1, '2023-10-30 10:50:25.128737', '1', '1', '1', '1', '1', '1', 8, '1', '1', '1', '1', '1');
...
INSERT INTO `evaluationsprodukcja` (`EvaluationID`, `UserName`, `UserID`, `EvaluatorNameID`, `Date`, `Question1`, `Question2`, `Question3`, `Question4`) VALUES
(1, '2', 1, 8, '2023-10-30 10:50:38.159158', '2', '2', '2', '2');
...
INSERT INTO `users` (`UserID`, `FullName`, `Password`, `Login`, `Enabled`) VALUES
(1, 'Testowy Test', 'test2', 'test', 1),
(2, 'Administrator', 'admin', 'admin', 1),
(3, 'Ksawery Nowak', 'test2', 'test2', 1),
(4, 'Sebastian D', 'test4', 'test4', 1);
...
--
ALTER TABLE `evaluations`
  MODIFY `EvaluationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
